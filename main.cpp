...
struct vertex
{
	...
	static string getMaxDegreeVertex()
	{
		return maxDegreeVertex;
	}
	static string getMinDegreeVertex()
	{
...
public:
	...
	void insertEdge(vertex *aV, vertex *bV, double w)
	{
		if (aV == bV)
			return; // not considering loops
	...
	int getDegreeOfVertex(string n)
	{
	...
	string showAllNeighbors(string n)
	{
		string nb;
